...
void dataRcv(int numBytes) {  
    if (numBytes > 2){
      ...
      paramMotorAnalogInput1 = i2c_rcv.substring(5, 9).toInt() - 1000;
      paramMotorAnalogInput2 = i2c_rcv.substring(9, 13).toInt() - 1000;
      paramTermAnalogInput1 = i2c_rcv.substring(13, 17).toInt() - 1000;
      paramTermAnalogInput2 = i2c_rcv.substring(17, 21).toInt() - 1000;
      paramTermInputForward1 = i2c_rcv.substring(1, 2).toInt();
      paramTermInputForward2 = i2c_rcv.substring(2, 3).toInt();
      paramTermInputBack1 = i2c_rcv.substring(3, 4).toInt();
      paramTermInputBack2 = i2c_rcv.substring(4, 5).toInt();
    }
    else{
      byte i2c_rcv[2];
      int x = 0;
      ...
      int sender = i2c_rcv[0] | i2c_rcv[1] << 8;
      Serial.print(" GET ");
